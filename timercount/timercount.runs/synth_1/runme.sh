...
HD_PWD='C:/Users/gsahi/Documents/GitHub/ee242fall2020/timercount/timercount.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Timer1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Timer1.tcl
